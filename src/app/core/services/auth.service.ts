...
export class AuthService {
  ...
  signup(formData: SignupData): Observable<any> {
    return this.http
      .post<any>(`${this.appUrl}/user/signup/creator`, formData)
  ...
  signin(data: SigninData): Observable<signinResponse> {
    ...
    return this.http
      .post<signinResponse>(`${this.appUrl}/auth/creator/signin`, data)
      .pipe(
  ...
  refreshToken(): Observable<any> {
    ...
    return this.http.get<any>(`${this.appUrl}/auth/creator/refresh_token`, {
      headers,
    });
  }
  ...
  check(pin: string) {
    this.http
      .post<any>(`${this.appUrl}/auth/check`, { pin, role: 'creator' })
      .pipe(catchError((error: HttpErrorResponse) => this.handleError(error)))
      .subscribe({
        next: (res: signinResponse) => {
